...
import "@/styles/header-transparent.css";
import "@/styles/collapsible-contact-form.css";
...
const PopupContactForm = dynamic(() => import('@/components/contact/PopupContactForm'), { ssr: false })
